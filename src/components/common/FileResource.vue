    ...
    <div style="padding: 10px;">
        <el-button-group>
            <el-button
                ...
                @click="refresh"
            ></el-button>
            <el-button type="primary" size="small" @click="isIcon = !isIcon">{{
                isIcon ? "列表" : "图标"
            }}</el-button>
            <span></span>
            <el-button
            ...
            >
                ...
                >
                    ...
                    <div slot="tip" class="el-upload__tip">
                        只能上传{{ uploadData.exts }}文件，且不超过{{
                            uploadData.size | renderSize
                        }}
                    </div>
                </el-upload>
                <el-button
        ...
        >
            <el-table-column v-if="isAll" width="55">
                <template slot-scope="scope">
                    <el-checkbox
                        v-model="scope.row.select"
                        @click="selectFile(scope.row, scope.$index)"
                    ></el-checkbox>
                </template>
            </el-table-column>
            <el-table-column prop="filename" label="文件名">
                <template slot-scope="scope">
                    <a
                        class="file-type-icon fileicon-small-pic"
                        :href="scope.row.url"
                        title="点击查看"
                        target="_blank"
                    ></a>
