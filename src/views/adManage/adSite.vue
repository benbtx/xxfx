<template>
    <div>
        ...
        <el-table v-loading="loading" :data="list" style="width: 100%;">
            <el-table-column label="ID" prop="siteId" fixed> </el-table-column>
            <el-table-column label="广告位名称" prop="siteName" fixed>
            </el-table-column>
            <el-table-column
                label="广告位描述"
                prop="describe"
                        ...
                        <div class="remove-list">
                            <draggable element="ul" v-model="formData.ads">
                                <li
                                    ...
                                    v-for="(item, index) in formData.ads"
                                    :key="index"
                                >
                                    {{ item.title }} -
                                    {{ item.describe }}（ID：{{ item.adId }}）
                                    <i
                                        class="el-icon-close remove-list-close"
                                        @click="handleAdClose(index)"
                                    ></i>
                                </li>
                            </draggable>
                        </div>
