<template>
    <div>
        ...
        <el-table v-loading="loading" :data="list" style="width: 100%;">
            <el-table-column label="ID" prop="adId" fixed> </el-table-column>
            <el-table-column
                label="标题"
                prop="title"
                with="300"
            ...
            <el-table-column label="封面" prop="picUrl">
        ...
        >
            <el-form :model="formData" :rules="formRules" ref="dataForm">
                ...
                <el-form-item
                    ...
                    prop="jumpUrl"
                    v-if="formData.jumpType === 0 || formData.jumpType === 2"
                >
                    <el-input
                ...
                <el-form-item
                    ...
                    prop="wxaAppid"
                    v-if="formData.jumpType === 2"
                >
                    <el-input
                        v-model="formData.wxaAppid"
                        auto-complete="off"
                    ></el-input>
                </el-form-item>
                ...
                <el-form-item label="渠道名单" required>
                    ...
                    >
                        <div class="remove-list-box">
                            ...
                            <div
                                v-show="formData.channelList.length >= 15"
                                style="color: red;"
                            >
                                到达最大次数，最大15个
                            </div>
                ...
                <el-form-item label="Android版本名单" required>
                    ...
                    <el-form-item
                        prop="androidVersionList"
                        v-if="formData.androidVersionType !== 0"
                    >
                        <div class="remove-list-box">
                            <div class="remove-list">
                                <div
                                    class="remove-list-item"
                                    v-for="(item,
                                    index) in formData.androidVersionList"
                                    :key="index"
                                >
                                    {{ item }}
                                    <i
                            ...
                            <div
                                v-show="
                                    formData.androidVersionList.length >= 15
                                "
                                style="color: red;"
                            >
                                到达最大次数，最大15个
                ...
                <el-form-item label="iOS版本名单" required>
                    ...
                    <el-form-item
                        prop="iosVersionList"
                        v-if="formData.iosVersionType !== 0"
                    >
                        <div class="remove-list-box">
                            <div class="remove-list">
                                <div
                                    class="remove-list-item"
                                    v-for="(item,
                                    index) in formData.iosVersionList"
                                    :key="index"
                                >
                                    {{ item }}
                                    <i
                            ...
                            <div
                                v-show="formData.iosVersionList.length >= 15"
                                style="color: red;"
                            >
                                到达最大次数，最大15个
                            </div>
